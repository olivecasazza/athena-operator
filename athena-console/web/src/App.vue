    ...
    >
      ...
      >
        ...
        >
          ...
          <span
            ...
            :class="activeTab === tab.id ? 'text-blue-300' : 'text-zinc-500'"
            >{{ tab.count }}</span
          >
        </button>
      </nav>
      ...
      <section v-if="activeTab === 'experiments' || activeTab === 'running'">
        <div class="mb-6 flex justify-between items-center gap-4">
          ...
          <button
            @click="refreshAll"
            class="bg-pink-900 hover:bg-blue-900 text-pink-100 hover:text-blue-100 px-4 py-2 text-sm transition-colors uppercase tracking-widest font-mono font-bold"
          >
            Refresh
          </button>
        </div>
          ...
          <table class="w-full text-left text-sm">
            ...
            <tbody>
              ...
              >
                ...
                <td class="py-3 pr-4">
                  <span class="px-2 py-1 text-xs bg-blue-950 text-blue-300">
                ...
                <td class="py-3 pr-4">
                  <button
                    class="border border-zinc-700 px-3 py-1 font-mono text-xs text-zinc-300 hover:border-pink-500 hover:text-white"
                    @click="openIde(exp)"
                  >
                    Open IDE
                  </button>
        ...
        <div class="bg-zinc-950 p-4 border border-zinc-700 md:col-span-2">
          ...
          >
            <div class="mb-4 flex flex-wrap items-start justify-between gap-4">
              ...
              <span
                class="border border-pink-900 px-3 py-2 font-mono text-xs text-pink-300"
      ...
      <section id="metrics" class="bg-zinc-950 p-4 border border-zinc-700">
        <div class="flex items-center justify-between gap-4">
          ...
          <a
            class="border border-zinc-700 px-3 py-2 font-mono text-xs text-zinc-300 hover:border-blue-200 hover:text-blue-300"
