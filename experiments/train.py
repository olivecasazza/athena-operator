"""
Stateless Athena workload entrypoint for Kubernetes-managed Experiment and BenchmarkRun Jobs.

Local execution is only a smoke test. Authoritative status, lifecycle, and metric
publication belong to the Athena controller, which parses the structured metrics
artifact written by this workload.
"""
